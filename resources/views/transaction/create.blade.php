            ...
            <div class="col-12 col-md-10">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="">New Transaction</h5><a href="{{ route('transaction.index') }}" class="btn btn-dark">back</a>
                        </div>
                    <div class="card-body">
...
{{-- {!! Form::date('Check_in', null, ['class' => 'form-control', 'id' => 'datepicker']) !!} --}}
                              <div class="mb-3">
                                <label class="form-label">Check in</label>
                                <input type="date" name="check_in" class="form-control">
                                <div class="form-text text-danger">@error('check_in') {{ $message }} @enderror</div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Check out</label>
                                <input type="date" name="check_out" class="form-control">
                                <div class="form-text text-danger">@error('check_out') {{ $message }} @enderror</div>
                            </div>
                            <div class="mb-3">
